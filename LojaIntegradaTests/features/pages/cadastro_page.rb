# Page class defining sign in elements and basic actions
class CadastroPage < SitePrism::Page
  ...
  element :criar_conta_button, '#formCadastroCompleto > form > '\
            'div.acao-editar.row-fluid > div > button'

  element :criado_sucesso, '#corpo > div > div.alert.alert-success.alert-geral'
  element :validacao_senha, '#formCadastroCompleto > form > '\
            'div.dados-acesso.row-fluid > div > div > fieldset > '\
            'div:nth-child(4) > div:nth-child(1) > span > ul > li'
